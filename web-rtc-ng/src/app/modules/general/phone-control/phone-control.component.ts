...
export class PhoneControlComponent {
    ...
    onAddContact(){
        //Выбирает существующий контакт из списка контактов пользователя.
        //Формирует из введенных данных телефона экземпляр контакта,
        //если этот экземпляр не существует в списке контактов пользователя.
	let contact : Contact,
